...
class AccountInvoice(models.Model):
    ...
    def generate_xml_file(self, model='account.invoice',cron=False):
        ...
        for active_id in active_ids:
            ...
            Emisor += '[Identificacion][Tipo]' + id.company_id.partner_id.tipo + '[|Tipo][Numero]' + id.company_id.company_registry + '[|Numero][|Identificacion]'
            Emisor += '[Ubicacion]'
            ...
            if id.company_id.phone:
                Emisor += '[Telefono][CodigoPais]506[|CodigoPais][NumTelefono]' + id.company_id.phone + '[|NumTelefono][|Telefono]'

            Emisor += '[CorreoElectronico]' + id.company_id.email + '[|CorreoElectronico][|Emisor]'
            invoice_dict += Emisor

            Receptor = '[Receptor][Nombre]' + id.partner_id.name + '[|Nombre]'
            Receptor += '[Identificacion][Tipo]' + id.partner_id.tipo + '[|Tipo][Numero]' + id.partner_id.vat + '[|Numero][|Identificacion]'
            Receptor += '[Ubicacion]'
